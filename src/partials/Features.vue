<template>
  <section class="relative">
    <!-- Bg illustration -->
    <div
      class="absolute left-1/2 -translate-x-1/2 pointer-events-none -mt-20 -z-10"
      aria-hidden="true"
    >
      <img
      ...
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          ...
          <div class="max-w-2xl mx-auto">
            <p class="text-xl text-slate-500">
              I am running a space-limited, 3-hour Live AI course on
              <br /><br />
            </p>
            <p class="text-lg text-slate-500">
              <strong>DATE:</strong>January 13th, 2024 at 12PM Pacific.
            </p>
        ...
        <div class="carousel swiper-container">
          <div class="swiper-wrapper">
            <!-- Carousel items -->
            <div
              class="swiper-slide h-auto flex flex-col bg-slate-800 p-6 rounded"
            >
              <img
                class="mb-3"
                src="../images/features-icon-01.svg"
                width="56"
                height="56"
                alt="Icon 01"
              />
            ...
            >
              <img
                class="mb-3"
                src="../images/features-icon-03.svg"
                width="56"
                height="56"
                alt="Icon 03"
              />
